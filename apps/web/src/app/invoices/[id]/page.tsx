    ...
    <>
      ...
      <div className="p-2 lg:p-3 max-w-4xl mx-auto print:p-0 print:max-w-none">
        ...
        {selectedTemplate ? (
          ...
          <div className="invoice-document bg-white border border-gray-200 rounded-2xl shadow-sm min-h-[920px] lg:min-h-[1122px]">
            <iframe
          ...
          <div
            id="invoice-document"
            className="invoice-document bg-white border border-gray-200 rounded-2xl overflow-hidden shadow-sm flex flex-col overflow-x-hidden print:overflow-visible min-h-[920px] lg:min-h-[1122px]"
          >
          {/* Top accent bar */}
          ...
          <div className="print:overflow-visible flex flex-1 flex-col">
            ...
            <div className="flex flex-col sm:flex-row sm:items-start justify-between gap-6 px-8 py-7 border-t border-gray-100">
              ...
              {/* Totals card */}
              <div className="w-fit min-w-72 max-w-full self-end rounded-xl overflow-hidden border border-gray-200 shadow-sm print:shadow-none inv-totals-card">
