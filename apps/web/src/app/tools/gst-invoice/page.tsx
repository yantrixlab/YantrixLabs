...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: 'https://yantrixlab.com/tools/gst-invoice',
  },
  openGraph: {
    ...
    url: 'https://yantrixlab.com/tools/gst-invoice',
...
export default function GSTInvoicePage() {
  return (
    <PublicLayout>
      ...
      <nav aria-label="Breadcrumb" className="container-wide pt-6 text-sm text-gray-500">
        <ol className="flex items-center gap-2">
          <li><Link href="/">Home</Link></li>
          <li aria-hidden="true">&gt;</li>
          <li><Link href="/tools">Tools</Link></li>
          <li aria-hidden="true">&gt;</li>
          <li className="text-gray-700">GST Invoice Tool</li>
        </ol>
      </nav>
