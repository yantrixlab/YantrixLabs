      ...
      >
        <div className="container-wide max-w-2xl mx-auto">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <Link href="/gst-invoice" className="inline-flex items-center justify-center gap-2 rounded-xl border px-8 py-4 text-base font-semibold transition-all" style={{ borderColor: '#4aa3ff', color: '#ffffff' }}>Try GST Tool</Link>
          </div>
        </div>
      </section>
    </PublicLayout>
