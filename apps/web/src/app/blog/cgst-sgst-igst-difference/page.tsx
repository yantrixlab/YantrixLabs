...
export default function Page() {
  return (
    <main className="container-wide py-16 max-w-4xl mx-auto prose prose-gray">
      ...
      <p>Choosing the right GST type is critical for compliance. The tax applied depends on supplier state and place of supply.</p><h2>Quick comparison table</h2><table><thead><tr><th>Type</th><th>When used</th><th>Who collects</th></tr></thead><tbody><tr><td>CGST</td><td>Intra-state sale</td><td>Central Govt</td></tr><tr><td>SGST</td><td>Intra-state sale</td><td>State Govt</td></tr><tr><td>IGST</td><td>Inter-state sale</td><td>Central Govt</td></tr></tbody></table><p>Use our <a href="/gst-invoice">GST invoice tool</a> to auto-calculate the correct split.</p>
    </main>
  );
}
