...
export function BlogHero({ search, onSearchChange }: Props) {
  return (
    <section className="public-hero public-hero-dark blog-hero-fixed relative bg-gradient-to-br from-brand-950 via-brand-900 to-brand-700 text-white py-28 px-4 overflow-hidden">
