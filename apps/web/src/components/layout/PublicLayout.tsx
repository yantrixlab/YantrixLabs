          ...
          <div className="grid md:grid-cols-4 gap-8 mb-10">
            ...
            <div>
              ...
              <ul className="space-y-2 text-sm">
                <li><Link href="/gst-invoice" className="hover:text-indigo-600 transition-colors">GST Invoice Tool</Link></li>
                <li><Link href="/tools" className="hover:text-indigo-600 transition-colors">All Products</Link></li>
                <li><Link href="/services" className="hover:text-indigo-600 transition-colors">Custom Development</Link></li>
                <li><Link href="/saas-development-services" className="hover:text-indigo-600 transition-colors">SaaS Development</Link></li>
                <li><Link href="/mobile-app-development-services" className="hover:text-indigo-600 transition-colors">Mobile App Development</Link></li>
                <li><Link href="/web-app-development-services" className="hover:text-indigo-600 transition-colors">Web App Development</Link></li>
              </ul>
            </div>
            <div>
              ...
              <ul className="space-y-2 text-sm">
                ...
                <li><Link href="/website-development-company-kolkata" className="hover:text-indigo-600 transition-colors">Kolkata Services</Link></li>
